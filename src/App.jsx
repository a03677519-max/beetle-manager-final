    ...
    <>
      ...
      <header className="bg-white text-emerald-900 border-b border-slate-200 p-4 pt-[calc(1rem+env(safe-area-inset-top))] sticky top-0 z-10">
        ...
        <button 
          ...
          className="fixed bottom-[calc(8.5rem+env(safe-area-inset-bottom))] right-6 w-16 h-16 bg-emerald-600 text-white rounded-full shadow-lg shadow-emerald-200 flex items-center justify-center active:scale-90 transition-all z-20"
        >
          <Plus size={40} />
        </button>
